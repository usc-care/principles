...
\noindent{\fontsize{36}{38}\selectfont{\color{black}{Principles of Quantitative Project Workflows}}} \\[.32cm]
...
\section{Gibson-researcher written \texttt{Stata} programs} \label{sec:ados}
